...
def model_opts(parser):
    ...
    group.add('--bert_dec_layers', '-bert_dec_layers', type=int, default=1,
              help='Number of layers in the bert decoder')   # ##
...
def train_opts(parser):
    ...
    group.add('--seed', '-seed', type=int, default=-1,
              help="""Random seed used for the experiments
                       reproducibility.""")
    group.add('--max_predictions_per_seq', '-max_predictions_per_seq', type=int, default=20,
              help="""The number of max mask words in each sentence""")
    group.add('--masked_lm_prob', '-masked_lm_prob', type=float, default=0.15,
              help="""The probability of the mask word in each sentence""")
    group.add('--use_masked_tgt', '-use_masked_tgt', action='store_false',
              help="""Use noised tgt.""")
    group.add('--select_layer', '-select_layer', type=int, default=-1,
              help="""Select a layer of decode for the Bert task""")
    group.add('--alpha', '-alpha', type=float, default=0.1,
              help="""the weight for the Bert task loss = loss + alpha*bert_loss""")
    # Init options
